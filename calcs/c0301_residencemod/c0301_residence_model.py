...
rc.doc("pdf", "default", "Residence Seismic Model", "24")

rc.I("""[01]  Seismic Demands for Exterior Walls
    ...
    """)
rc.V("""[02]  Seismic Capacities and D-C ratios for Exterior Walls
    ...
    **D-C ratios are shown for 6" oc boundary nails and estimated DC ratios if
    ...
    """)
# %%
rc.I("""[03]  Seismic D-C ratios for Foundation Walls
