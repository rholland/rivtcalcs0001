...
rc.doc("pdf", "default", "Code Minimums - Carport Renovations", "21")

# %%
rc.I("""[01] Structural Deficiencies
    ...
    """)
rc.I("""[02]  Carport Repairs and Strengthening
    ...
    """)
rc.V("""[03]  Seismic Model Inputs - CBC Requirements
